...
> 当前版本：`v1.6.1` · 插画化三栏阅读、编辑、AI 辅助、Notebook 与正文标记
>
...
- 折叠图标回到未折叠标题栏的高度，并贴近中间阅读区一侧；折叠状态移除两侧竖线。
...
当前本地目标：`feat/reader-visual-simplification` / `v1.6.1`；稳定基线：`main` / `v0.9.0`。本轮只做本地提交，不自动推送或合并。
