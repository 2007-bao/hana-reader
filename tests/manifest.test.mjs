...
test('manifest declares the v0.7.2 reader page with guarded resource access', async () => {
...
test('reader source, built assets, and cache-busting route are present', async () => {
  ...
  assert.match(route, /ASSET_REVISION = '0\.7\.2'/);
  ...
  assert.match(panelSource, /const PLUGIN_VERSION = '0\.7\.2'/);
